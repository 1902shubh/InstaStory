...
import papaya.instastory.MainActivity;
...
public class ProfileAdapter  extends RecyclerView.Adapter<ProfileAdapter.ViewHolder> {
    ...
    public ProfileAdapter(Context context2, ArrayList<TrayModel> arrayList
    ...
    public void updateList(ArrayList<TrayModel> list) {
